                        ...
                        <div class="row row-sm text-center">
                            <div class="col-xs-6">
                                <div class="panel padder-v item">
                                    <div class="h1 text-info font-thin h1"><c:out value="${userCount}"></c:out></div>
                            ...
                            <div class="col-xs-6">
                                <div class="panel padder-v item bg-info">
                                    <div class="h1 text-fff font-thin h1"><c:out value="${categorycount}"></c:out></div>
                                    <span class="text-muted text-xs">分类数量</span>
                                    <div class="top text-right w-full">
                                        <i class="fa fa-caret-down text-warning m-r-sm"></i>
                                    </div>
                                </div>
                            ...
                            <div class="col-xs-6">
                                <div class="panel padder-v item bg-primary">
                                    <div class="h1 text-fff font-thin h1"><c:out value="${topiccount}"></c:out></div>
                                    <span class="text-muted text-xs">主题数量</span>
                                    <div class="top text-right w-full">
                                        <i class="fa fa-caret-down text-warning m-r-sm"></i>
                                    </div>
                                </div>
                            ...
                            <div class="col-xs-6">
                                <div class="panel padder-v item">
                                    <div class="font-thin h1"><c:out value="${replycount}"></c:out></div>
                                    <span class="text-muted text-xs">回复数量</span>
                            ...
                            <a href="/admin/profile.html">
                                <div class="col-sm-4">
                                    <div class="text-center">
                                        <img alt="image" class="img-circle m-sm img-responsive" src="<c:out value="${loginUser.img}"></c:out>">
                                            <div class="m-t-xs font-bold">3C课堂-3C论坛</div>
                                    </div>
                                </div>
                                <div class="col-sm-8">
                                    <h3><strong><c:out value="${loginUser.username}"></c:out></strong></h3>
                                    <p><i class="fa fa-map-marker"></i> 福建·厦门</p>
                                    <address>
                                        <abbr title="Phone">Tel:</abbr> <c:out value="${loginUser.phone}"></c:out>
                                    </address>
                                </div>
                        ...
                        <div class="" id="ibox-content">
                            ...
                            <div id="vertical-timeline" class="vertical-container light-timeline">
                                ...
                                <div class="vertical-timeline-block">
                                    ...
                                    <div class="vertical-timeline-content">
                                        <h2>项目1.3测试</h2>
                                        <p>1.3论坛测试修复bug，UI重构！</p>
                                        <a href="#" class="btn btn-sm btn-success"> UI重构 </a>
                                        <span class="vertical-date">
                                    2021年 <br>
                                    <small>6月6日</small>
                                </span>
                                ...
                                <div class="vertical-timeline-block">
                                    ...
                                    <div class="vertical-timeline-content">
                                        ...
                                        <span class="vertical-date"> 2020年 <br><small>5月1日</small></span>
                                    </div>
                                </div>
