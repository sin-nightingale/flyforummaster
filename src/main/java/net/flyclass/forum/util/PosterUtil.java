...
import net.flyclass.forum.domain.Poster;
    ...
    public static Poster initPoster(Poster poster_) {
      ...
      /* poster.setAvatarUrl(avatarUrl);
       ...
       poster.setNameY(poster.getAvatarY()+poster.getAvatarHeight()/2+15);*/
        ...
        poster.setDescX((poster_.getWidth()-"标题：".length()*size)/6-15);
        ...
        poster.setResultX((poster_.getWidth()-"内容：".length()*size)/6-15);
        ...
        //tips2
        poster.setTip2("好文章和好友一起分享！");//好物与好友一起分享
        ...
        //footer tips
        poster.setFooterTip("好文章和好友一起分享！");
...
//       g.drawImage(Thumbnails.of(goodsImage).size(poster.getGoodsWidth(), poster.getGoodsHeight()).asBufferedImage(), poster.getGoodsX(), poster.getGoodsY(), null);
        ...
        g.drawString("标题：", poster.getDescX(), poster.getDescY());
        //测评结果标题
