...
<form class="form-horizontal" role="form" action="/admin?method=topicgather" method="post">
                        ...
                        <td>
                                ...
                                <tr>
                                    <td class="wthree-logo" align="center">
                                        <a href="#" style="font-family:'Bell Gothic Std', sans-serif; color: #fefefe; font-size: 40px; text-decoration: none; padding: 12px 26px 13px 26px; border-radius: 4px; text-transform:uppercase">采集并发布主题 </a>
                                    </td>
                                </tr>
                                <tr>
    ...
    <div class="wrapper wrapper-content">
        ...
        <div class="row">
            <div class="form-group">
                <label class="col-sm-3 control-label">博客园地址：<a href="https://www.cnblogs.com/wtzbk/">https://www.cnblogs.com/wtzbk/</a></label>
            </div>
        </div>
        ...
        <div class="row">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input id="firstname" name="add" class="form-control" type="text" required="">
                </div>
            </div>
        </div>

    </div>
    <button style="border-radius:30px ;" class='uploadbutton uploadbutton1'>采集并发布主题</button>
</form>
