            ...
            <div class="col-12 text-center align-self-center py-5">
                <div class="section pb-5 pt-5 pt-sm-2 text-center">
                    ...
                    <div class="card-3d-wrap mx-auto">
                        <div class="card-3d-wrapper"style="position: relative;text-align: left;">
                            ...
                            <div class="card-front">
                                <div class="center-wrap">
                                    <div class="section text-center">
                                        ...
                                        <a href="${pageContext.request.contextPath}forgetpsw.jsp" style="color: #c4c3ca;position: absolute;left: 75%;top: 87%;">忘记密码？</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-back"  style="position: relative;text-align: left;">
                                <div class="center-wrap">
                                    <div class="section text-center">
                                        ...
                                        <form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/user?method=register" method="post" style="margin: 10px 0 -30px 0px;">
                                            <div class="form-group">
